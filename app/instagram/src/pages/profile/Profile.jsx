    ...
    <div className="myaccount">
      ...
      <div className='main'>
        ...
        <div className='main__posts'>
          {loggedUser?.posts[0] ? loggedUser?.posts.map((x)=><MainPosts x={x} mobile={mobile} handelViewPostModal={handelViewPostModal}/>) : <img onClick={()=>setModalPost(!modalPost)} style={{cursor:'pointer',margin:'5rem 0',height:'150px',width: '150px'}} src={addPhoto} rel="add" />}
        </div>
      </div>
    </div>
  )
